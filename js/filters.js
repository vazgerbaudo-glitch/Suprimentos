...
m_apply.onclick = () => {
    ...
    STATE.metaServ = parseFloat(m_serv.value) || STATE.metaServ;
    render();
};
m_ag_apply.onclick = () => {
    STATE.metaAgG = parseFloat(m_agg.value) || STATE.metaAgG;
    STATE.metaAgC = parseFloat(m_agc.value) || STATE.metaAgC;
    STATE.metaAgS = parseFloat(m_ags.value) || STATE.metaAgS;
    render();
};
