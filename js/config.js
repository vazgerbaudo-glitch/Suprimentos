...
// saving cobrem 2026 inteiro via DATA_INI_VOL, a aba Prod & Velocidade só conta a partir de abr/2026 via
// DATA_INI_PROD, e a aderência ao SLA só conta a partir de abr/2026 via DATA_INI_SLA.
const HOJE = new Date(),
    DATA_INI = new Date(2026, 3, 1),
    DATA_INI_VOL = new Date(2026, 0, 1),
    DATA_INI_PROD = new Date(2026, 3, 1),
