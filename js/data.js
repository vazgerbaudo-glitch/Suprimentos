...
// Filtro lateral "Carteira" — código da Carteira/Categoria (ex.: G35), carregado pela própria base
// Gestão à Vista (ALL/ALLRC, campo r.ccd). A aba Contratualização usa r.car (Spend/rcRows), campo
// diferente do mesmo espaço de códigos — filtrada à parte em renderContr (js/render.js).
const carHit = r => STATE.car === 'GERAL' || r.ccd === STATE.car;
